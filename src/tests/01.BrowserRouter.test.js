...
describe('1 - Crie as rotas necessárias para a aplicação', () => {
  ...
  it(
    'Será validado que rota / é uma rota existente e que ela renderiza com data-testid page-login ser acessada',
    async () => {
      localStorage.clear();
      renderPath('/');
  ...
  it(
    'Será validado que rota /search é uma rota existente e que ela renderiza o componente com data-testid page-search',
    async () => {
      renderPath('/search');
  ...
  it(
    'Será validado que rota /album/:id é uma rota existente e que ela renderiza o componente com data-testid page-album',
    async () => {
      localStorage.setItem('user', JSON.stringify(defaultUser));
  ...
  it(
    'Será validado que rota /favorites é uma rota existente e que ela renderiza o componente com data-testid page-favorites',
    async () => {
      localStorage.setItem('favorite_songs', JSON.stringify([]));
  ...
  it(
    'Será validado que rota /profile é uma rota existente e que ela renderiza o componente com data-testid page-profile',
    async () => {
      renderPath('/profile');
  ...
  it(
    'Será validado que rota /profile/edit é uma rota existente e que ela renderiza o componente com data-testid page-profile-edit',
    async () => {
